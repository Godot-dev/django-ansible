...
SECRET_KEY = 'django-insecure--o9ygx2$y$#nhs9b2s%zf@4a*o20q*wu=t743-==p-gckf)rl#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['0.0.0.0', '10.0.103.167', 'localhost', '127.0.0.1']
...
CORS_ALLOW_HEADERS = [
    'content-type',
    'x-csrftoken',  # Ajouter l'en-tête CSRF ici
    'accept',
    'origin',
    'authorization',
    'x-requested-with',
...
#CORS_ALLOW_ALL_ORIGINS = True # a suppr
